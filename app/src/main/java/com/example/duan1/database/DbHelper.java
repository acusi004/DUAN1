...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String donHang = "CREATE TABLE DONHANG (MADONHANG INTEGER PRIMARY KEY AUTOINCREMENT, TRANGTHAI INTEGER ,SDT TEXT, DIACHI TEXT, CONTENT TEXT,TONGTIEN INTEGER, MAGIOHANG INTEGER REFERENCES GIOHANG(MAGIOHANG))";
        db.execSQL(donHang);
