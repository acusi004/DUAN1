...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String monAn = "CREATE TABLE MONAN (MAMONAN INTEGER PRIMARY KEY AUTOINCREMENT, TENMON TEXT, GIAMON INTGER,  MOTA TEXT,HINHANH TEXT, TENLOAI INTEGER REFERENCES LOAIMON(TENLOAI))";
        db.execSQL(monAn);
        ...
        String donHang = "CREATE TABLE DONHANG (MADONHANG INTEGER PRIMARY KEY AUTOINCREMENT, TRANGTHAI INTEGER ,SDT TEXT, DIACHI TEXT, CONTENT TEXT,MAGIOHANG INTEGER REFERENCES GIOHANG(MAGIOHANG), MAMONAN INTEGER REFERENCES MONAN(MAMONAN))";
        db.execSQL(donHang);
